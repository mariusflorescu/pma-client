    ...
    <div className="flex items-center justify-center w-full h-screen bg-gray-100">
      ...
      <div className="grid grid-cols-2 bg-white border border-gray-300 rounded">
           <div className="py-12">
              ...
              {/* Message */}
              <h3 className="pb-12 text-xl font-semibold text-center text-gray-600">Log in to your account</h3>
            ...
            onSubmit = {
                ...
                /> 
                {
                  errors.password && (<small className = "text-xs text-red-500">Invalid credentials</small>)
                } 
